package com.darko.main.utilities.tamedexpire;
			...
			if(p.getInventory().getItemInMainHand().getType().equals(Material.LEAD)) {
				...
				if (event.getRightClicked() != null) {
					...
					if(event.getRightClicked() instanceof Tameable) {
						...
						/**
						 * Always check for null
						 * TODO, check if it's needed to check if owner is instance of player?
						...
						if(tameable.getOwner() != null) {
						    ...
						    /**
						     * Possible fix for skelehorses, check if the owner has played before
						     * TODO check this fix
						     */
							...
							/**
							 * This is where we check how long the player has been offline for.
							 * MC stores this in milliseconds, so we convert the offline time to days first and compare it to GP config value for claim expirationdays.
							 * 
							 */

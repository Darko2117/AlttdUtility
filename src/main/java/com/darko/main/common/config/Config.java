...
public class Config {
    ...
    private enum Messages {
        ...
        SeatInvalidBlock("Messages.SeatInvalidBlock", "&cInvalid block."),
        SeatInvalidBlockAbove("Messages.SeatInvalidBlockAbove", "&cInvalid block above."),
        SeatInvalidBlockBelow("Messages.SeatInvalidBlockBelow", "&cInvalid block below."),

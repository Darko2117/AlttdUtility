...
public class Config {
    ...
    public static void configSetup() {
        ...
        // GodModeReminderDelay

        if (!config.contains("GodModeReminderDelay")) {

            config.set("GodModeReminderDelay", 12000);

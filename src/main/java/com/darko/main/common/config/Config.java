...
public class Config {
    ...
    public static void configSetup() {
        ...
        if (!config.contains("GodModeReminderDelay")) {
            ...
            config.set("GodModeReminderDelay", 600);
